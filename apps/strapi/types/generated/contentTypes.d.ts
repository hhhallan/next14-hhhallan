...
export interface ApiHeroSectionHeroSection extends Struct.SingleTypeSchema {
  ...
  attributes: {
    buttons: Schema.Attribute.DynamicZone<['components.button']>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiProjectSectionProjectSection
  ...
  attributes: {
    ...
    subtitle: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'voici quelques uns de mes projets favoris'>;
    tag: Schema.Attribute.String & Schema.Attribute.DefaultTo<'Projets'>;
    title: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Derni\u00E8res r\u00E9alisations'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
